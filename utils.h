...
public:
    ...
    QByteArray toJson() const
    {
        ...
        foreach (const SourceTargetMapping &mapping, m_files) {
            QJsonObject object;
            object.insert(QString::fromLatin1("source"), QDir::toNativeSeparators(mapping.first));
            object.insert(QString::fromLatin1("target"), QDir::toNativeSeparators(mapping.second));
            files.append(object);
        }
        document.insert(QString::fromLatin1("files"), files);
