...
#include "utils.h"
#include "qmlutils.h"
#include "qt592/qcommandlineoption.h"
#include "qt592/qcommandlineparser.h"
...
#endif
{
    ...
    QtCoreModule2              = 0x0000000000000004,
...
static QtModuleEntry qtModuleEntries[] = {
    { QtBluetoothModule, "bluetooth", "QtBluetooth", 0 },
    { QtConcurrentModule, "concurrent", "QtConcurrent", "qtbase" },
    { QtCoreModule2, "core", "QtCore", "qtbase" },
    { QtDeclarativeModule, "declarative", "QtDeclarative", "qtquick1" },
    { QtDesignerModule, "designer", "QtDesigner", 0 },
    { QtDesignerComponents, "designercomponents", "QtDesignerComponents", 0 },
    { QtEnginioModule, "enginio", "Enginio", 0 },
    { QtGamePadModule, "gamepad", "QtGamepad", 0 },
    { QtGuiModule, "gui", "QtGui", "qtbase" },
    { QtHelpModule, "qthelp", "QtHelp", "qt_help" },
    { QtMultimediaModule, "multimedia", "QtMultimedia", "qtmultimedia" },
    { QtMultimediaWidgetsModule, "multimediawidgets", "QtMultimediaWidgets", "qtmultimedia" },
    { QtMultimediaQuickModule, "multimediaquick", "QtMultimediaQuick_p", "qtmultimedia" },
    { QtNetworkModule, "network", "QtNetwork", "qtbase" },
    { QtNfcModule, "nfc", "QtNfc", 0 },
    { QtOpenGLModule, "opengl", "QtOpenGL", 0 },
    { QtPositioningModule, "positioning", "QtPositioning", 0 },
    { QtPrintSupportModule, "printsupport", "QtPrintSupport", 0 },
    { QtQmlModule, "qml", "QtQml", "qtdeclarative" },
    { QtQmlToolingModule, "qmltooling", "qmltooling", 0 },
    { QtQuickModule, "quick", "QtQuick", "qtdeclarative" },
    { QtQuickParticlesModule, "quickparticles", "QtQuickParticles", 0 },
    { QtQuickWidgetsModule, "quickwidgets", "QtQuickWidgets", 0 },
    { QtScriptModule, "script", "QtScript", "qtscript" },
    { QtScriptToolsModule, "scripttools", "QtScriptTools", "qtscript" },
    { QtSensorsModule, "sensors", "QtSensors", 0 },
    { QtSerialPortModule, "serialport", "QtSerialPort", "qtserialport" },
    { QtSqlModule, "sql", "QtSql", "qtbase" },
    { QtSvgModule, "svg", "QtSvg", 0 },
    { QtTestModule, "test", "QtTest", "qtbase" },
    { QtWebKitModule, "webkit", "QtWebKit", 0 },
    { QtWebKitWidgetsModule, "webkitwidgets", "QtWebKitWidgets", 0 },
    { QtWebSocketsModule, "websockets", "QtWebSockets", 0 },
    { QtWidgetsModule, "widgets", "QtWidgets", "qtbase" },
    { QtWinExtrasModule, "winextras", "QtWinExtras", 0 },
    { QtXmlModule, "xml", "QtXml", "qtbase" },
    { QtXmlPatternsModule, "xmlpatterns", "QtXmlPatterns", "qtxmlpatterns" },
    { QtWebEngineCoreModule, "webenginecore", "QtWebEngineCore", 0 },
    { QtWebEngineModule, "webengine", "QtWebEngine", "qtwebengine" },
    { QtWebEngineWidgetsModule, "webenginewidgets", "QtWebEngineWidgets", 0 },
    { Qt3DCoreModule, "3dcore", "Qt3DCore", 0 },
    { Qt3DRendererModule, "3drenderer", "Qt3DRender", 0 },
    { Qt3DQuickModule, "3dquick", "Qt3DQuick", 0 },
    { Qt3DQuickRendererModule, "3dquickrenderer", "Qt3DQuickRender", 0 },
    { Qt3DInputModule, "3dinput", "Qt3DInput", 0 },
    { QtLocationModule, "geoservices", "QtLocation", 0 },
    { QtWebChannelModule, "webchannel", "QtWebChannel", 0 },
    { QtTextToSpeechModule, "texttospeech", "QtTextToSpeech", 0 },
    { QtSerialBusModule, "serialbus", "QtSerialBus", 0 }
};
...
static inline QString webProcessBinary(const char *binaryName, Platform p)
{
    ...
    return (p & WindowsBased) ? webProcess + QString::fromLatin1(".exe") : webProcess;
}
...
struct Options {
    ...
    Options()
        ...
        , quickImports(true)
        , translations(true)
        , systemD3dCompiler(true)
        , compilerRunTime(true)
        , angleDetection(AngleDetectionAuto)
        , softwareRasterizer(true)
        , platform(Windows)
        , additionalLibraries(0)
        , disabledLibraries(0)
        , updateFileFlags(0)
        , json(nullptr)
        , list(ListNone)
        , debugDetection(DebugDetectionAuto)
        , deployPdb(false)
        , dryRun(false)
        , patchQt(true)
    {
                                 ...
                                 Options *options, QString *errorMessage)
{
    ...
    parser->setApplicationDescription(QString::fromLatin1("Qt Deploy Tool ") + QLatin1String(QT_VERSION_STR)
    ...
    QCommandLineOption dirOption(QString::fromLatin1("dir"),
                                 QString::fromLatin1("Use directory instead of binary directory."),
                                 QString::fromLatin1("directory"));
    parser->addOption(dirOption);

    QCommandLineOption libDirOption(QString::fromLatin1("libdir"),
                                    QString::fromLatin1("Copy libraries to path."),
                                    QString::fromLatin1("path"));
    parser->addOption(libDirOption);

    QCommandLineOption pluginDirOption(QString::fromLatin1("plugindir"),
                                       QString::fromLatin1("Copy plugins to path."),
                                       QString::fromLatin1("path"));
    parser->addOption(pluginDirOption);

    QCommandLineOption debugOption(QString::fromLatin1("debug"),
                                   QString::fromLatin1("Assume debug binaries."));
    parser->addOption(debugOption);
    QCommandLineOption releaseOption(QString::fromLatin1("release"),
                                   QString::fromLatin1("Assume release binaries."));
    parser->addOption(releaseOption);
    QCommandLineOption releaseWithDebugInfoOption(QString::fromLatin1("release-with-debug-info"),
                                                  QString::fromLatin1("Assume release binaries with debug information."));
    ...
    QCommandLineOption deployPdbOption(QString::fromLatin1("pdb"),
                                       QString::fromLatin1("Deploy .pdb files (MSVC)."));
    parser->addOption(deployPdbOption);

    QCommandLineOption forceOption(QString::fromLatin1("force"),
                                    QString::fromLatin1("Force updating files."));
    parser->addOption(forceOption);

    QCommandLineOption dryRunOption(QString::fromLatin1("dry-run"),
                                    QString::fromLatin1("Simulation mode. Behave normally, but do not copy/update any files."));
    parser->addOption(dryRunOption);

    QCommandLineOption noPatchQtOption(QString::fromLatin1("no-patchqt"),
                                       QString::fromLatin1("Do not patch the Qt5Core library."));
    parser->addOption(noPatchQtOption);

    QCommandLineOption noPluginsOption(QString::fromLatin1("no-plugins"),
                                       QString::fromLatin1("Skip plugin deployment."));
    parser->addOption(noPluginsOption);

    QCommandLineOption noLibraryOption(QString::fromLatin1("no-libraries"),
                                       QString::fromLatin1("Skip library deployment."));
    parser->addOption(noLibraryOption);

    QCommandLineOption qmlDirOption(QString::fromLatin1("qmldir"),
                                    QString::fromLatin1("Scan for QML-imports starting from directory."),
                                    QString::fromLatin1("directory"));
    parser->addOption(qmlDirOption);

    QCommandLineOption noQuickImportOption(QString::fromLatin1("no-quick-import"),
                                           QString::fromLatin1("Skip deployment of Qt Quick imports."));
    parser->addOption(noQuickImportOption);

    QCommandLineOption noTranslationOption(QString::fromLatin1("no-translations"),
                                           QString::fromLatin1("Skip deployment of translations."));
    parser->addOption(noTranslationOption);

    QCommandLineOption noSystemD3DCompilerOption(QString::fromLatin1("no-system-d3d-compiler"),
                                                 QString::fromLatin1("Skip deployment of the system D3D compiler."));
    parser->addOption(noSystemD3DCompilerOption);


    QCommandLineOption compilerRunTimeOption(QString::fromLatin1("compiler-runtime"),
                                             QString::fromLatin1("Deploy compiler runtime (Desktop only)."));
    parser->addOption(compilerRunTimeOption);

    QCommandLineOption noCompilerRunTimeOption(QString::fromLatin1("no-compiler-runtime"),
                                             QString::fromLatin1("Do not deploy compiler runtime (Desktop only)."));
    parser->addOption(noCompilerRunTimeOption);

    QCommandLineOption webKitOption(QString::fromLatin1("webkit2"),
                                    QString::fromLatin1("Deployment of WebKit2 (web process)."));
    parser->addOption(webKitOption);

    QCommandLineOption noWebKitOption(QString::fromLatin1("no-webkit2"),
                                      QString::fromLatin1("Skip deployment of WebKit2."));
    parser->addOption(noWebKitOption);

    QCommandLineOption jsonOption(QString::fromLatin1("json"),
                                  QString::fromLatin1("Print to stdout in JSON format."));
    parser->addOption(jsonOption);

    QCommandLineOption angleOption(QString::fromLatin1("angle"),
                                   QString::fromLatin1("Force deployment of ANGLE."));
    parser->addOption(angleOption);

    QCommandLineOption noAngleOption(QString::fromLatin1("no-angle"),
                                     QString::fromLatin1("Disable deployment of ANGLE."));
    parser->addOption(noAngleOption);

    QCommandLineOption suppressSoftwareRasterizerOption(QString::fromLatin1("no-opengl-sw"),
                                                        QString::fromLatin1("Do not deploy the software rasterizer library."));
    parser->addOption(suppressSoftwareRasterizerOption);

    QCommandLineOption listOption(QString::fromLatin1("list"),
    ...
    QCommandLineOption verboseOption(QString::fromLatin1("verbose"),
                                     QString::fromLatin1("Verbose level."),
                                     QString::fromLatin1("level"));
    parser->addOption(verboseOption);

    parser->addPositionalArgument(QString::fromLatin1("[files]"),
                                  QString::fromLatin1("Binaries or directory containing the binary."));
    ...
    for (size_t i = 0; i < qtModulesCount; ++i) {
        ...
        const QString enabledDescription = QString::fromLatin1("Add ") + name + QString::fromLatin1(" module.");
        ...
        const QString disabledDescription = QString::fromLatin1("Remove ") + name + QString::fromLatin1(" module.");
        CommandLineOptionPtr disabledOption(new QCommandLineOption(QString::fromLatin1("no-") + option,
                                                                   disabledDescription));
    ...
    if (options->compilerRunTime && options->platform != WindowsMinGW && options->platform != Windows) {
        *errorMessage = QString::fromLatin1("Deployment of the compiler runtime is implemented for Desktop only.");
        return CommandLineParseError;
    }
    ...
    if (parser->isSet(listOption)) {
        ...
        if (value == QString::fromLatin1("source")) {
            options->list = ListSource;
        } else if (value == QString::fromLatin1("target")) {
            options->list = ListTarget;
        } else if (value == QString::fromLatin1("relative")) {
            options->list = ListRelative;
        } else if (value == QString::fromLatin1("mapping")) {
            options->list = ListMapping;
        } else {
            *errorMessage = QString::fromLatin1("Please specify a valid option for -list (source, target, relative, mapping).");
            return CommandLineParseError;
        }
    }
    ...
    if (parser->isSet(jsonOption) || options->list) {
        ...
        if (parser->isSet(verboseOption)) {
            ...
            if (!ok || optVerboseLevel < 0) {
                *errorMessage = QString::fromLatin1("Invalid value \"%1\" passed for verbose level.").arg(value);
                return CommandLineParseError;
            }
        }
    }
    ...
    if (posArgs.isEmpty()) {
        *errorMessage = QString::fromLatin1("Please specify the binary or folder.");
    ...
    if (!options->directory.isEmpty() && !fi.isFile()) { // -dir was specified - expecting file.
        *errorMessage = QLatin1Char('"') + file + QString::fromLatin1("\" is not an executable file.");
        return CommandLineParseError;
    }
    ...
    if (fi.isFile()) {
        ...
        if (binary.isEmpty()) {
            *errorMessage = QString::fromLatin1("Unable to find binary in \"") + file + QLatin1Char('"');
            return CommandLineParseError;
        }
...
{
    return QStringList() << QString::fromLatin1("*.jsc") << QString::fromLatin1("*.qmlc");
}
...
private:
    ...
    {
        QStringList result;
        result << QString::fromLatin1("qmldir") << QString::fromLatin1("*.qmltypes")
           << QString::fromLatin1("*.frag") << QString::fromLatin1("*.vert") // Shaders
           << QString::fromLatin1("*.ttf");
        if (!(flags & SkipSources)) {
            result << QString::fromLatin1("*.js") << QString::fromLatin1("*.qml") << QString::fromLatin1("*.png");
...
static quint64 qtModule(QString module, const QString &infix)
{
    ...
    const size_t qtModulesCount = sizeof(qtModuleEntries)/sizeof(QtModuleEntry);
    for (size_t i = 0; i < qtModulesCount; ++i) {
        const QString libraryName = QString::fromLatin1(qtModuleEntries[i].libraryName);
        if (module.startsWith(libraryName)
                          ...
                          DebugMatchMode debugMatchModeIn, Platform platform, QString *platformPlugin)
{
    ...
    foreach (const QFileInfo &subDirFi , pluginDirs) {
        ...
        if (module & *usedQtModules) {
            ...
            if (isPlatformPlugin) {
                ...
                case WinCEIntel:
                case WinCEArm:
                    filter = QString::fromLatin1("qwindows");
                    break;
                case WinRtIntel:
                case WinRtArm:
                    filter = QString::fromLatin1("qwinrt");
                    break;
                case Unix:
                    filter = QString::fromLatin1("libqxcb");
                    break;
    ...
    for (size_t i = 0; i < qtModulesCount; ++i) {
        if ((qtModuleEntries[i].module & modules) && qtModuleEntries[i].translation) {
            const QString name = QLatin1String(qtModuleEntries[i].translation) +
                                 QLatin1Char('_') +  prefix + QString::fromLatin1(".qm");
                               ...
                               const QString &target, unsigned flags, QString *errorMessage)
{
    ...
    const QStringList qmFilter = QStringList(QString::fromLatin1("qt_*.qm"));
    const QFileInfoList &qmFiles = sourceDir.entryInfoList(qmFilter);
    QList<QLocale> list;
    QFileInfoList listqm;
    foreach (const QFileInfo &qmFi , qmFiles) {
        QString qmFile = qmFi.baseName();
        if(qmFile.contains(QString::fromLatin1("help")))
            continue;
        qmFile.remove(0, 3);
        qmFile.remove(QString::fromLatin1(".qm"));
        QLocale locale(qmFile);
        if(!list.contains(locale))
        {
            list.append(locale);
            listqm.push_back(qmFi);
        }
    }
    if (listqm.isEmpty()) {
    ...
    QDir targetDir(absoluteTarget);
    targetDir.mkpath(QString::fromLatin1("."));

    foreach (const QFileInfo &info , listqm) {
        QString targetFile = targetDir.filePath(info.fileName());
        if(QFile::copy(info.absoluteFilePath(), targetDir.filePath(info.fileName())))
            std::wcout << "Creating " << targetFile << "...\n";
        else
            std::wcout << "Copy file Filed: " << targetFile << "...\n";
    } // for prefixes.
    return true;
}
                           ...
                           const QString &qtLibInfix, Platform platform, bool debug)
{
    ...
    if (platform & WindowsBased) {
        ...
        result += QString::fromLatin1("lib");
        result += QLatin1String(name);
        result += qtLibInfix;
    }
    result += QLatin1Char('4');
    result += sharedLibrarySuffix(platform);
    return result;
}

static QString vcDebugRedistDir() { return QString::fromLatin1("Debug_NonRedist"); }
...
static QString vcRedistDir()
{
    ...
    vcRedistDirName.append(QString::fromLatin1("redist"));
    ...
    const QString vc2017RedistDirName = vcRedistDirName + QString::fromLatin1("/MSVC");
...
static QStringList compilerRunTimeLibs(Platform platform, bool isDebug, unsigned wordSize)
{
    ...
    case WindowsMinGW: { // MinGW: Add runtime libraries
        ...
        const QString gcc = findInPath(QString::fromLatin1("g++.exe"));
        if (gcc.isEmpty()) {
        ...
        foreach (const QFileInfo &dllFi , dlls)
    ...
    case Windows: { // MSVC/Desktop: Add redistributable packages.
        ...
        if (isDebug) {
            ...
            if (vcRedistDir.cd(vcDebugRedistDir()) && vcRedistDir.cd(wordSizeString)) {
                const QStringList names = vcRedistDir.entryList(QStringList(QString::fromLatin1("Microsoft.VC*.DebugCRT")), QDir::Dirs);
                if (!names.isEmpty() && vcRedistDir.cd(names.first())) {
                    ...
                    foreach (const QFileInfo &dll , dlls)
                        redistFiles.append(dll.absoluteFilePath());
                }
            }
        } else { // release: Bundle vcredist<>.exe
            QString releaseRedistDir = vcRedistDirName;
            const QStringList countryCodes = vcRedistDir.entryList(QStringList(QString::fromLatin1("[0-9]*")), QDir::Dirs);
            if (!countryCodes.isEmpty()) // Pre MSVC2017
                releaseRedistDir += QLatin1Char('/') + countryCodes.first();
            const QFileInfo fi(releaseRedistDir + QLatin1Char('/')
                               + QString::fromLatin1("vcredist_") + wordSizeString
                               + QString::fromLatin1(".exe"));
            if (fi.isFile())
        ...
        {
            QDir sdkv70 = QString::fromLocal8Bit(qgetenv("WINDOWSSDKDIR"));
            const QFileInfo fi(sdkv70.filePath(QString::fromLatin1("Bootstrapper/Packages/vcredist_%1/vcredist_%2.exe").arg(wordSizeString).arg(wordSizeString)));
            if (fi.isFile())
                redistFiles.append(fi.absoluteFilePath());
        }
...
{
    const QString versionString = qmakeVariables.value(QString::fromLatin1("QT_VERSION"));
                          ...
                          const Options &options, QString *errorMessage)
{
    ...
    if (options.deployPdb) {
        ...
        if (pdb.isFile())
            return updateFile(pdb.absoluteFilePath(), targetDirectory, options.updateFileFlags, NULL, errorMessage);
    }
    return true;
}
                           ...
                           QString *errorMessage)
{
    ...
    const QString qtBinDir = qmakeVariables.value(QString::fromLatin1("QT_INSTALL_BINS"));
    const QString libraryLocation = options.platform == Unix ? qmakeVariables.value(QString::fromLatin1("QT_INSTALL_LIBS")) : qtBinDir;
    ...
    if (dependentQtLibs.isEmpty()) {
        *errorMessage = QDir::toNativeSeparators(options.binaries.first()) +  QString::fromLatin1(" does not seem to be a Qt executable.");
        return result;
    }
    ...
    if (options.platform & WindowsBased)  {
        const QStringList qtLibs = dependentQtLibs.filter(QString::fromLatin1("Qt5Core"), Qt::CaseInsensitive)
            + dependentQtLibs.filter(QString::fromLatin1("Qt5WebKit"), Qt::CaseInsensitive);
        foreach (const QString &qtLib , qtLibs) {
            QStringList icuLibs = findDependentLibraries(qtLib, options.platform, errorMessage).filter(QString::fromLatin1("ICU"), Qt::CaseInsensitive);
            if (!icuLibs.isEmpty()) {
                // Find out the ICU version to add the data library icudtXX.dll, which does not show
                // as a dependency.
                QRegExp numberExpression(QString::fromLatin1("\\d+"));
                ...
                if (index >= 0)  {
                    ...
                    icuLibs.push_back(QString::fromLatin1("icudt") + icuVersion + QLatin1String(windowsSharedLibrarySuffix));
                }
                foreach (const QString &icuLib , (icuLibs)) {
                    const QString icuPath = findInPath(icuLib);
                    if (icuPath.isEmpty()) {
                        *errorMessage = QString::fromLatin1("Unable to locate ICU library ") + icuLib;
                        return result;
                    }
    ...
    if (options.quickImports && usesQml2) {
        ...
        foreach (const QString &qmlDirectory , (qmlDirectories)) {
            ...
            const QmlImportScanResult scanResult =
                runQmlImportScanner(qmlDirectory, qmakeVariables.value(QString::fromLatin1("QT_INSTALL_QML")),
    ...
    const QStringList plugins =
        findQtPlugins(&result.deployedQtLibraries,
                      ...
                      qmakeVariables.value(QString::fromLatin1("QT_INSTALL_PLUGINS")), libraryLocation, infix,
    ...
    if (optVerboseLevel > 1)
        std::wcout << "Plugins: " << plugins.join(QChar::fromLatin1(',')) << '\n';

//    if ((result.deployedQtLibraries & QtGuiModule) && platformPlugin.isEmpty()) {
//        *errorMessage =QString::fromLatin1("Unable to find the platform plugin.");
//        return result;
//    }
    ...
    if ((options.platform & WindowsBased) && options.platform != WinCEIntel
        ...
        QString libGlesName = QString::fromLatin1("libGLESV2");
        if (isDebug)
            libGlesName += QLatin1Char('d');
        libGlesName += QLatin1String(windowsSharedLibrarySuffix);
        QString libCombinedQtAngleName = QString::fromLatin1("QtANGLE");
        if (isDebug)
        ...
        const bool dependsOnOpenGl = !guiLibraries.filter(QString::fromLatin1("opengl32"), Qt::CaseInsensitive).isEmpty();
        if (options.angleDetection != Options::AngleDetectionForceOff
            ...
            if (QFileInfo(combinedAngleFullPath).exists()) {
                ...
                QString libEglFullPath = qtBinDir + slash + QString::fromLatin1("libEGL");
                if (isDebug)
        ...
        if (options.softwareRasterizer && !dependsOnOpenGl) {
            const QFileInfo softwareRasterizer(qtBinDir + slash + QString::fromLatin1("opengl32sw") + QLatin1String(windowsSharedLibrarySuffix));
    ...
    if (isDebug && options.platform == WinRtArm
             && qmakeVariables.value(QString::fromLatin1("QMAKE_XSPEC")).endsWith(QLatin1String("msvc2015"))) {
        ...
        if (extensionPath.isEmpty() || ucrtVersion.isEmpty()) {
            ...
            const QString ucrtbasedLib = extensionPath
                    + QString::fromLatin1("/Microsoft.UniversalCRT.Debug/")
                    + ucrtVersion
                    + QString::fromLatin1("/Redist/Debug/arm/ucrtbased.dll");
    ...
    if (options.libraries) {
        ...
        foreach (const QString &qtLib , (libraries)) {
            updateLibrary(qtLib, targetPath, options, errorMessage);
//                return result;
        }
        ...
        foreach (const QString &plugin , plugins) {
            ...
            if (!dir.exists(targetDirName)) {
                ...
                if (!(options.updateFileFlags & SkipUpdateFile) && !dir.mkdir(targetDirName)) {
                    *errorMessage = QString::fromLatin1("Cannot create ") + targetDirName +  QLatin1Char('.');
                    return result;
                }
            }
    ...
    if (options.quickImports && (usesQuick1 || usesQml2)) {
        ...
        if (usesQuick1) {
            const QString quick1ImportPath = qmakeVariables.value(QString::fromLatin1("QT_INSTALL_IMPORTS"));
            ...
            QStringList quick1Imports(QString::fromLatin1("Qt"));
            if (result.deployedQtLibraries & QtWebKitModule)
                quick1Imports << QString::fromLatin1("QtWebKit");
    ...
    if (options.translations) {
        if (!options.dryRun && !createDirectory(options.translationsDirectory, errorMessage))
            return result;
        if (!deployTranslations(qmakeVariables.value(QString::fromLatin1("QT_INSTALL_TRANSLATIONS")),
                             ...
                             const Options &sourceOptions, QString *errorMessage)
{
    ...
    const QString webProcessSource = qmakeVariables.value(QString::fromLatin1("QT_INSTALL_LIBEXECS")) +
                                ...
                                const Options &options, bool isDebug, QString *errorMessage)
{
    ...
    if (!deployWebProcess(qmakeVariables, webEngineProcessName, options, errorMessage))
        return false;
    const QString resourcesSubDir = QString::fromLatin1("/resources");
    const QString resourcesSourceDir
        = qmakeVariables.value(QString::fromLatin1("QT_INSTALL_DATA")) + resourcesSubDir
            + QLatin1Char('/');
    ...
    const QFileInfo translations(qmakeVariables.value(QString::fromLatin1("QT_INSTALL_TRANSLATIONS"))
                                 + QString::fromLatin1("/qtwebengine_locales"));
    ...
    if (options.translations) {
        ...
        const QFileInfo enUSpak(translations.filePath() + QString::fromLatin1("/en-US.pak"));
        if (!enUSpak.exists()) {
...
int main(int argc, char **argv)
{
    ...
    const QString xSpec = QString::fromLatin1("win32-msvc2010");//qmakeVariables.value(QString::fromLatin1("QMAKE_XSPEC"));
    ...
    if (qmakeVariables.isEmpty() || xSpec.isEmpty() || !qmakeVariables.contains(QString::fromLatin1("QT_INSTALL_BINS"))) {
